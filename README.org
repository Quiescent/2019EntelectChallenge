...
** DONE Investigate state divergence
   ...
   :END:
** IN_PROGRESS BUG: I interpret invalid moves as no move
   :LOGBOOK:
...
** TODO BUG: I generate moves from current position for frozen worms
   :LOGBOOK:
   - Note taken on [2019-08-25 Sun 12:45] \\
     These should be filtered.
   :END:
** IN_PROGRESS BUG: Some of my moves are invalid
   :LOGBOOK:
...
** TODO BUG: I'm not determining whether a swap happened
** TODO IDEA: If I make the payoff relative then trees become circular (Opportunity for massive improvement to algorithm)
   ...
   :END:
** TODO Never select the current worm
