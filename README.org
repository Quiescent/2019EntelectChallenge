...
** DONE Limit selects to the 5th percentile of certainty
   ...
   :END:
** IN_PROGRESS Make health and points worth more than distance from enemy in points search
   :LOGBOOK:
   - State "IN_PROGRESS" from "TODO"       [2019-09-01 Sun 09:09]
   :END:
** TODO Make my health worth twice as much as my damage in kill search
