...
*** DONE Unroll move ordering and choice logic to avoid allocation and expensive checks
    ...
    - CLOSING NOTE [2019-08-17 Sat 11:38] \\
      Adding retrospectively
    :END:
*** TODO Investigate why makeMoves is still allocating a lot of memory
...
*** DEFUNCT Pass down whether there is a dig move
    ...
    - Note taken on [2019-08-17 Sat 11:37] \\
      ...
      way anymore.
    :END:
** TODO Only kill worms at the end of a round
** TODO Use a better scoring function during the kill search
** TODO Use confidence in the dig search, but correct the formula for different maximums
