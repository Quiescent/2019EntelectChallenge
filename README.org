...
** IN_PROGRESS Never select or throw ammo when there's no clear winner
   ...
   :END:
** TODO When there's no clear winner then select a random move from the top contenders
   :LOGBOOK:
   - Note taken on [2019-08-30 Fri 17:25] \\
     This should make my bot less predictable.
   :END:
