...
**** DONE Make opponent mirror player
     ...
     :END:
**** IN_PROGRESS Make weapon a state level attribute
     :LOGBOOK:
     - State "IN_PROGRESS" from "TODO"       [2019-05-01 Wed 15:15]
     :END:
**** IN_PROGRESS Make diggingRange a state level attribute
     :LOGBOOK:
     - State "IN_PROGRESS" from "TODO"       [2019-05-01 Wed 15:17]
     :END:
**** IN_PROGRESS Make movementRange a state level attribute
     :LOGBOOK:
     - State "IN_PROGRESS" from "TODO"       [2019-05-01 Wed 15:17]
     :END:
