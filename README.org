...
** DONE Make my health worth twice as much as my damage in kill search
   ...
   - CLOSING NOTE [2019-09-01 Sun 10:39] \\
     Closing retrospectively
   :END:
** DONE IDEA: Run away strategy
   CLOSED: [2019-09-07 Sat 08:57]
   :LOGBOOK:
   - CLOSING NOTE [2019-09-07 Sat 08:57]
   - Note taken on [2019-09-05 Thu 06:50] \\
     I think that I should improve this by encouraging my worms not to move
     to the edge of the map.
   - State "IN_PROGRESS" from "TODO"       [2019-09-05 Thu 05:39]
   :END:
*** DONE Implement A* for Running Away
    CLOSED: [2019-09-07 Sat 07:41]
    :LOGBOOK:
    - CLOSING NOTE [2019-09-07 Sat 07:41] \\
      Works beautifully!
    - State "IN_PROGRESS" from "TODO"       [2019-09-06 Fri 05:19]
    :END:
*** DONE Don't runaway into the same line of fire
    CLOSED: [2019-09-07 Sat 08:56]
    :LOGBOOK:
    - CLOSING NOTE [2019-09-07 Sat 08:56]
    - State "IN_PROGRESS" from "TODO"       [2019-09-07 Sat 07:41]
    :END:
** DONE Fix spurious Shoot East
   CLOSED: [2019-09-07 Sat 09:20]
   :LOGBOOK:
   - CLOSING NOTE [2019-09-07 Sat 09:20] \\
     False alarm.  I had two worms alive and the one could definitely shoot
     East.
   - State "IN_PROGRESS" from "TODO"       [2019-09-07 Sat 09:00]
   :END:
** IN_PROGRESS Swap to traditional search when I can "see" then end
   :LOGBOOK:
   - Note taken on [2019-09-07 Sat 14:55] \\
     This is not working at all.  I'm going back to searching up to the end
     of the search front.
   - Note taken on [2019-09-07 Sat 14:03] \\
     I'm not searching enough.  I'm going to cap the moves into the future
     to 25.  In many cases that should be enough because at this points the
     points matter.
   - Note taken on [2019-09-07 Sat 13:49] \\
     I need to maintain the search tree for the end game search.  It'll be
     super useful for it to get better with every turn.
   - Note taken on [2019-09-07 Sat 13:49] \\
     That's fixed he problem.  I wasn't filtering alignment correctly.
     
     I also just excluded lava moves because they're pretty bad in general
     and the end game search is already really taxing.
   - Note taken on [2019-09-07 Sat 13:16] \\
     Found the problem.  I was passing the wrong state down as the final
     state when doing random and unsearched nodes.
   - Note taken on [2019-09-07 Sat 13:06] \\
     There's something horribly wrong with how I'm filtering out my move
     moves in the end game.  I'm not moving when I'm aligned and I'm not
     considering moving when I'm not aligned (!?)
   - Note taken on [2019-09-07 Sat 12:40] \\
     Another big problem surfaced.  The way that I update trees needs to
     change for the end game search to work.  The final state here is only
     applicable to searches where I don't look ahead.
     
     Actually a better solution is to keep track of the state where I hit
     the search front(!)
   - Note taken on [2019-09-07 Sat 12:31] \\
     It turns out that it was the end game condition which was the last
     problem in getting this to work without blowing up in my face.
   - Note taken on [2019-09-07 Sat 11:50] \\
     There's a problem with the end state where it checks conditions on
     non-existent worms.  I'm tracking down the issue by turning on `prof'
     and running with `xc'.
   - Note taken on [2019-09-07 Sat 11:30] \\
     Needed to fix bugs for:
      - the round being 401 and the bot checking for lava on a square;
      - there being no moves to make because the worm is dead;
      - there being no valid moves from here; (This one worries me a bit.
        It might be caused by some invalid check)
   - State "IN_PROGRESS" from "TODO"       [2019-09-07 Sat 09:21]
   - Note taken on [2019-09-07 Sat 08:58] \\
     The idea here is that when the board is small enough I should switch
     to the following strategy:
      - If I'm in the line of fire or I can't hit any opponent then I can
        move or shoot.
      - Otherwise I just shoot.
     Always run these games to completion.
   ...
   :END:
** IN_PROGRESS I need to change the rule for runaway
   :LOGBOOK:
   - Note taken on [2019-09-07 Sat 14:03] \\
     I'm breaking the rules by doing two things at the same time, but I
     feel that I need to because the compile times are sooo long.
   - State "IN_PROGRESS" from "TODO"       [2019-09-07 Sat 14:03]
   - Note taken on [2019-09-07 Sat 10:50] \\
     Right now the worms run aimlessly and don't get enough points.  They
     should only run if it's apparent that the opponents strategy is to
     gang up on me.
   :END:
** IN_PROGRESS What do I do after round 200 when worms aren't nearby?
   :LOGBOOK:
   - Note taken on [2019-09-07 Sat 14:21] \\
     I'm going with points on this one.
   - State "IN_PROGRESS" from "TODO"       [2019-09-07 Sat 14:21]
   - Note taken on [2019-09-07 Sat 13:01] \\
     I should probably go into points mode until there are nearby worms.
   :END:
** TODO Swap out points for DIG and make dig not go on lava
...
*** DONE Use an unboxed vector for the tree
    ...
    :END:
*** DONE Investigate Int Map implementation being slower
    CLOSED: [2019-09-04 Wed 05:09]
    :LOGBOOK:
    - CLOSING NOTE [2019-09-04 Wed 05:09] \\
      Problems appear to come from the usages of the tree.  e.g. I was using
      ~find~ at one point and ~find~ uses a linear traversal instead of
      indexing into the tree.
    - State "IN_PROGRESS" from "TODO"       [2019-09-03 Tue 18:42]
    :END:
*** DONE Optimise `nextSearchMove' by turning it into a strict left fold
    CLOSED: [2019-09-04 Wed 05:39]
    :LOGBOOK:
    - CLOSING NOTE [2019-09-04 Wed 05:39] \\
      Retrospectively completing task
    - State "IN_PROGRESS" from "TODO"       [2019-09-04 Wed 05:11]
    - Note taken on [2019-09-04 Wed 05:10] \\
      Idea is to remove multiple calls to confidence.
    :END:
*** DONE Optimise out the use of elems
    CLOSED: [2019-09-04 Wed 05:48]
    :LOGBOOK:
    - CLOSING NOTE [2019-09-04 Wed 05:48]
    - State "IN_PROGRESS" from "TODO"       [2019-09-04 Wed 05:39]
    - Note taken on [2019-09-04 Wed 05:11] \\
      It's allocating a lot and it's slower than folding over the tree.
    :END:
*** DONE Eliminate possible moves to search through when the enemy is too far from me
    CLOSED: [2019-09-04 Wed 06:01]
    :LOGBOOK:
    - CLOSING NOTE [2019-09-04 Wed 06:01]
    - State "IN_PROGRESS" from "TODO"       [2019-09-04 Wed 05:48]
    - Note taken on [2019-09-03 Tue 17:02] \\
      I forgot to start this task (or the revert undid it).
    - State "IN_PROGRESS" from "TODO"       [2019-09-03 Tue 17:02]
    ...
    :END:
*** DONE Eliminate possible moves to search through with direction to enemy
    CLOSED: [2019-09-05 Thu 05:38]
    :LOGBOOK:
    - CLOSING NOTE [2019-09-05 Thu 05:38]
    - State "IN_PROGRESS" from "TODO"       [2019-09-04 Wed 06:02]
    - Note taken on [2019-09-01 Sun 20:13] \\
