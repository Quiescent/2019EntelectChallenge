...
** DONE Implement search function
   ...
   - CLOSING NOTE [2019-07-10 Wed 05:20]
   :END:
** TODO Implement Banana Bomb
*** IN_PROGRESS Encode banana bomb
    :LOGBOOK:
    - State "IN_PROGRESS" from "TODO"       [2019-07-10 Wed 05:46]
    :END:
*** IN_PROGRESS Rule 1: Banana bombs have a maximum range of 5
    :LOGBOOK:
    ...
    :END:
*** TODO Rule 2: Banana bombs do 20 damage at the landing site
*** TODO Rule 3: Banana bombs have an impact radius of 2
*** TODO Rule 4: Banana bombs do less damage the further from the landing site you're hit
*** TODO Rule 5: Banana bombs destroy all dirt
*** TODO Rule 6: You get points for destroying dirt as though you dug it out
*** TODO Rule 7: The banana bomb destroys power ups
*** TODO Rule 8: Both players receive points for dirt destroyed simultaneously by bombs
*** TODO Rule 9: You receive 2 * damage as points for damaging enemies
*** TODO Rule 10: You lose 2 * damage as points for damaging your own worms
*** TODO Rule 11: Killing an enemy awards 40 points
** TODO Implement Select
*** TODO Encode select
*** TODO Make select moves ahead of others
