...
***** DONE Rule 3: Digging space penalises your score by 4
      ...
      :END:
**** IN_PROGRESS Implement Shoot
     :LOGBOOK:
     - State "IN_PROGRESS" from "TODO"       [2019-06-10 Mon 13:58]
     :END:
***** IN_PROGRESS Implement a Scenario Generator and Test It
      :LOGBOOK:
      - State "IN_PROGRESS" from "TODO"       [2019-06-10 Mon 13:58]
      :END:
****** IN_PROGRESS Implement worms hitting other worms in range scenarios
       :LOGBOOK:
       - State "IN_PROGRESS" from "TODO"       [2019-06-10 Mon 13:58]
       :END:
****** TODO Implement shots being blocked by dirt or space scenarios
****** TODO Implement worms being just out of range scenarios
****** TODO Implement simultaneous shots scenarios
