...
*** DONE Add snowballs to search
    ...
    :END:
** IN_PROGRESS Implement "Minigames" strategy
   :LOGBOOK:
...
are in the minigame.
*** IN_PROGRESS Implement a test for finding worms within a radius of my current worm
    :LOGBOOK:
    - State "IN_PROGRESS" from "TODO"       [2019-08-09 Fri 15:33]
    :END:
*** TODO Implement a test for choosing the strategy based on the number of worms
*** TODO Implement movesFrom for each strategy
** TODO Implement Lava
