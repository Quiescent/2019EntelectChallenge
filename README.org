...
***** DONE Rule 6: Moving to a square which is occupied by another worm results in no change
      ...
      :END:
***** TODO Rule 7: Moving to a square which contains a medipack changes that square to air and increases that worms health
***** TODO Rule 8: Simultaneous moves to a medipack result in only one worm getting the health from the medipack
***** TODO Rule 9: Moving off the edge of the map does nothing
**** TODO Implement Score Changes for Move
***** TODO Rule 1: Moving to dirt penalises your score by 4
***** TODO Rule 2: Moving to space penalises your score by 4
***** TODO Rule 3: Moving to air increases your score by 5
**** TODO Implement Dig
***** TODO Rule 1: Digging air does nothing
***** TODO Rule 2: Digging dirt clears the square
***** TODO Rule 3: Digging space does nothing
**** TODO Implement Score Changes for Digging
***** TODO Rule 1: Digging air penalises your score by 4
***** TODO Rule 2: Digging dirt increases your score by 7
***** TODO Rule 3: Digging space penalises your score by 4
