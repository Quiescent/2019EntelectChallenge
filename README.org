...
***** DONE Rule 1: Two do nothings should do nothing
      ...
      :END:
***** TODO Rule 2: Moving to dirt does not move the worm
***** TODO Rule 3: Moving to space does not move the worm
***** TODO Rule 4: Moving to air does move the worm
***** TODO Rule 5: Moving to the same square causes one of the worms to remain where it is
      :LOGBOOK:
