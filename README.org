...
*** DONE Encode select
    ...
    :END:
*** IN_PROGRESS Make select moves ahead of others
    :LOGBOOK:
    - State "IN_PROGRESS" from "TODO"       [2019-07-17 Wed 05:50]
    :END:
** TODO Implement Banana Bombs Parsing for Worms
*** TODO Implement test for ignoring the banana move when no banana bombs left
*** TODO Implement test for not throwing the banana when the wrong worm is selected
** TODO Implement Selection Parsing
*** TODO Implement the test for ignoring select when there are no selects left
** TODO Implement Selection of Banana Bombs
