...
***** DONE Rule 4: Moving to air does move the worm
      ...
      - CLOSING NOTE [2019-05-23 Thu 12:43]
      :END:
***** IN_PROGRESS Rule 5: Moving to the same square causes one of the worms to remain where it is and both to take damage
      :LOGBOOK:
      ...
      - Note taken on [2019-05-08 Wed 11:05] \\
        ...
        who wins.
      :END:
***** TODO Rule 6: Moving to a square which is occupied by another worm results in no change
