...
echo "======================================================================"
./bin/Profile-exe $* +RTS -hc -p -N2 -xc
...
mv Profile-exe.svg "$OUTPUT_DIRECTORY/$CURRENT_COMMIT-$MATCH_ARG_STRING-heap-by-function.svg"

echo "Done.  You can find the results in $OUTPUT_DIRECTORY/$CURRENT_COMMIT-$MATCH_ARG_STRING-heap-by-function.svg"
